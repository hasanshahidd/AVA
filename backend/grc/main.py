...
# --- Ava (cybersecurity assurance): non-cyber feature modules removed ---
...
# Automation control library — SOC 2 quantitative + framework-aware control
# libraries over the SCF catalog. `common` MUST be registered before the
# {framework} router so /automation/common/* matches the literal route, not the
# {framework} path param (framework="common").
...
def on_startup():
    ...
    # Ava: compliance schema self-heal removed along with the compliance module.
