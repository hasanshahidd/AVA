...
class SLAIntegrationService:
    ...
    def assign_sla_deadline(db: Session, vuln: Vulnerability):
        severity = (vuln.ava_severity or vuln.severity or "medium").lower()
                ...
                try:
                    ...
                    if assignee.email:
                        EmailService.send_sla_breach(
                            ...
                            severity=vuln.ava_severity or vuln.severity or "medium",
    ...
    def _vuln_summary(vuln: Vulnerability, sla_status: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "vuln_id": vuln.vuln_id,
            "title": vuln.title,
            "severity": vuln.ava_severity or vuln.severity,
            "status": vuln.status,
