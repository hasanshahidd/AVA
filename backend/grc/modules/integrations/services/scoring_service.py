...
from ..adapters.transformer import Rapid7Transformer, _compute_ava_severity
...
class ScoringService:
    ...
    def recalculate_vulnerability_score(
        ...
        old_score = vuln.ava_risk_score
        old_severity = vuln.ava_severity

        vuln.ava_risk_score = composite
        vuln.ava_severity = _compute_ava_severity(composite)
        ...
        return {
            ...
            "new_severity": vuln.ava_severity,
            "factors": {
                "cvss": best_cvss,
                "nexpose_risk": nexpose_risk,
                "asset_criticality": asset_criticality,
    ...
    def batch_recalculate(
        ...
        for vuln in vulns:
            try:
                ...
                if vuln.ava_risk_score != composite:
                    vuln.ava_risk_score = composite
                    vuln.ava_severity = _compute_ava_severity(composite)
                    vuln.updated_at = datetime.utcnow()
                    updated += 1
