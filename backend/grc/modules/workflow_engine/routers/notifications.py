...
def test_email_config(
    ...
    try:
        # Create test message
        msg = MIMEMultipart()
        msg['From'] = f"{config.from_name or 'Ava'} <{config.from_email}>"
        msg['To'] = test_email
        msg['Subject'] = "Test Email from Ava Workflow Engine"
        
        body = """
        <html>
        <body>
            <h2>Email Configuration Test</h2>
            <p>This is a test email from your Ava workflow engine.</p>
