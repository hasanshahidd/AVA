...
def _build_windows_script(token: str, handshake_url: str, tenant_id: int) -> str:
    ...
    return f"""# Ava Connect Wizard — Windows installer
...
Write-Host ""
Write-Host "=== Ava Connect Wizard ===" -ForegroundColor Cyan
...
# Step 7 — handshake back to Ava
Write-Host "[7/7] Registering with Ava..." -ForegroundColor Cyan
$body = @{{
...
try {{
    ...
    Write-Host "      ERROR contacting Ava: $($_.Exception.Message)" -ForegroundColor Red
    exit 1
}}
...
Write-Host "  Ava  : registered (auto-asset created)"
Write-Host ""
Write-Host "Switch back to the Ava browser tab — it auto-detects this." -ForegroundColor Cyan
"""
...
# Ava Connect Wizard — Linux installer (read-only SSH access)
...
echo "=== CONNECTED ==="
echo "  Host: $HOST"
echo "Switch back to Ava — UI auto-detects."
"""
