                          ...
                          <div key={it.id}>
                            <div className="flex flex-col gap-2 px-4 py-3 lg:flex-row lg:items-start">
                              <div className="flex w-24 shrink-0 flex-col gap-1">
                                ...
                                {it.priority && <span className="rounded px-1.5 py-0.5 text-[10px] font-bold" style={it.priority === 'high' ? { background: '#EFF5FA', color: '#014A81' } : { background: '#f1f5f9', color: '#64748b' }}>{it.priority === 'high' ? 'Essential' : 'Sub'}</span>}
                              </div>
