...
// Ava logo — a 3D orb (the internet-facing attack surface) with an orbiting
// radar ring + a detected blip, beside the "Ava" wordmark. Matches the favicon.
