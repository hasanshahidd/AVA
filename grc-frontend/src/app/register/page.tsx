    ...
    <div className="space-y-2.5">
      ...
      <label className="flex cursor-pointer items-start gap-3 rounded-lg border border-slate-200 bg-white p-2.5">
        ...
        <span className="text-sm text-slate-600">
          I agree to the{' '}
          <a href="https://ava.ai/terms" target="_blank" rel="noopener noreferrer" className="font-medium text-primary-700 hover:text-primary-800">Terms of Service</a>{' '}
          and{' '}
          <a href="https://ava.ai/privacy-policy" target="_blank" rel="noopener noreferrer" className="font-medium text-primary-700 hover:text-primary-800">Privacy Policy</a>.
        </span>
      </label>
    </div>
  );
      ...
      <div className="mt-3.5 flex gap-3">
        ...
        {step < 4 ? (
          <button
            type="button"
            onClick={handleNext}
            className="auth-cta group flex flex-1 items-center justify-center gap-2 rounded-full bg-gradient-to-r from-primary-400 via-primary-600 to-primary-700 px-4 py-3 text-sm font-bold text-white shadow-[0_14px_30px_-14px_rgba(0,91,150,0.65)] transition-all hover:-translate-y-0.5 hover:shadow-[0_18px_36px_-14px_rgba(0,91,150,0.7)]"
          >
