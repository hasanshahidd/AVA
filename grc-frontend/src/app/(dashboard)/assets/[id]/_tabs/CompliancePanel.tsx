            ...
            <>
              ...
              {swWithBench.map((s: any) => (
                <div key={s.id} className="flex items-center gap-3 px-[18px] py-[11px] border-b border-[#F0F3F5]">
                  ...
                  <div className="flex-1 min-w-0">
                    <Link href={`/assets/${s.id}?tab=compliance`} className="text-[12px] font-semibold text-[#0F1F2B] hover:text-[#014A81]">{s.name}</Link>{' '}
          ...
          {suggestion.benchmark_name ? (
            <>
              ...
              <p className="mt-2 text-[11px] text-[#8A95A1]">
                ...
                <Link href="/compliance-plugins/os-registry" className="text-[#014A81] underline">admin → mappings</Link>
            ...
            <p className="mt-1 text-[12px] text-[#3A4653]">
              ...
              upload it via{' '}
              <Link href="/compliance-plugins/ingest" className="text-[#014A81] underline">Rules library → Ingest</Link>{' '}
