...
type ScopeAuth = {
  ...
  actor?: string;         // the Ava user who recorded it
            ...
            {tab === 'own' ? (
              ...
              <div style={{ marginTop: 14 }}>
                ...
                <label style={{ display: 'flex', alignItems: 'flex-start', gap: 8, marginTop: 12, fontSize: 11.5, color: '#3A4653', cursor: 'pointer', maxWidth: 520 }}>
                  ...
                  <span>I confirm Ava has documented written authorization from the domain owner to perform active scanning of <b className="mono" style={{ fontFamily: MONO }}>{root || defaultRoot}</b>.</span>
                </label>
                <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
