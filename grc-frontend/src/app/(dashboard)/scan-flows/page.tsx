    ...
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-500 mt-1 max-w-2xl">
          Two ways to bring vulnerabilities into Ava. Pick the flow that matches the client, then fill its form.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        >
          ...
          <p className="text-sm text-slate-500 mb-4">
            For clients with <b>no scanner of their own</b>. Ava&apos;s scan engine scans their network — you enter the target subnet and start the scan.
          </p>
          <ul className="text-xs text-slate-500 space-y-1 mb-5">
            <li>• Ava&apos;s scan engine (behind our backend, private)</li>
            <li>• Enter the client subnet → start a scan</li>
            <li>• Findings pulled into Ava automatically</li>
          </ul>
        ...
        >
          ...
          <p className="text-sm text-slate-500 mb-4">
            Client already runs their own scanner. Enter its <b>URL + API keys</b> and Ava pulls the findings via the API.
          </p>
          <ul className="text-xs text-slate-500 space-y-1 mb-5">
