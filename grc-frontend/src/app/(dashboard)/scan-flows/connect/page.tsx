...
import ConnectionsPage from '@/app/(dashboard)/integrations/connections/page';
  ...
  return (
    <div>
      <div className="px-6 pt-6">
        <Link href="/scan-flows" className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-slate-700 mb-2">
        ...
        <p className="text-sm text-slate-500 mt-1">
          Add the client&apos;s Nessus connection — URL + access key + secret key — then <b>Sync Now</b> on it to pull their findings into Ava.
        </p>
      </div>
      <ConnectionsPage />
    </div>
