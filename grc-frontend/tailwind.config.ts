...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Ava brand — navy/steel blue palette (core #005B96; anchors
        ...
        // Alias Tailwind's built-in indigo to the brand scale so legacy
        // `*-indigo-*` classes across the app follow the rebrand too.
        indigo: {
          50: '#eff5fa',
          100: '#dce9f3',
          200: '#b3cde0',
